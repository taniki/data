...
# évolution annuelle des restriction d'eau

:::{.callout-important appearance="simple"}
Contenu encore en cours d'écriture et de peaufinage. Je suis en début en cartographie et en geopandas, il y a certainment moyen d'optimiser le code. Je compte également apporter plus de nuance à la visualisation finale.
:::
...
[cquest]: data.cquest.org/propluvia/
...
### carte pour une année et une niveau d'alerte
